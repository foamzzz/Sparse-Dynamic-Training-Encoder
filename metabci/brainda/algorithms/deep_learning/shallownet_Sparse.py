...
from .base import SkorchNet,SparseEncoder
import math
...
class ShallowNet_Sparse(nn.Module):
    ...
    def __init__(self,n_time_filters, time_kernel, n_space_filters,pool_kernel,pool_stride, n_channels: int, n_samples: int, n_classes: int, shared_ratio=0.3, alpha=1.0, epsilon=20):
...
##########################
        print(f"in:{fake_output.shape[1]}\nout:{n_classes}")
