...
# BETA_URL = "https://bci.med.tsinghua.edu.cn/upload/liubingchuan_BETA_wof/" # 加wof是没有滤波的版本
BETA_URL = "http://bci.med.tsinghua.edu.cn/upload/liubingchuan/"  # 403 error # 不加wof是用eegfit 3-100hz滤波后的版本
# BETA_URL = 'https://figshare.com/articles/The_BETA_database/12264401'

Zhu_URL = "https://bci.med.tsinghua.edu.cn/upload/zhufangkun/"
...
class Zhu2021(BaseDataset):
    ...
    Sensors 2021, 21, 1256. https://doi.org/10.3390/s21041256
    ...
    def data_path(
        ...
        subject = cast(int, subject)
        url = "{:s}S{:d}.mat.zip".format(Zhu2021_URL, subject)
        file_dest = mne_data_path(
            url,
            "tsinghua",
            path=path,
